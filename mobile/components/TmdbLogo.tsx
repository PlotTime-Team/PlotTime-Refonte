// Logo officiel TMDb (The Movie Database) — asset v2 « blue_square », rendu
// vectoriel via react-native-svg. Tracé et dégradé OFFICIELS, non modifiés (la
// charte TMDb interdit de recolorer/déformer/pivoter le logo). Affiché pour
// l'attribution obligatoire de l'usage de l'API TMDb (Réglages › À propos).
// Doit rester MOINS proéminent que la marque PlotTime.
import React from 'react';
import Svg, { Path, Defs, LinearGradient, Stop } from 'react-native-svg';

const RATIO = 133.4 / 185.04;

export function TmdbLogo({ width = 46 }: { width?: number }) {
  return (
    <Svg
      width={width}
      height={width * RATIO}
