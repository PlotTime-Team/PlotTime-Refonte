...
const styles = StyleSheet.create({
  ...
  feedName: { color: COLORS.text, fontFamily: FONTS.extraBold },
  ...
  poster: { width: 40, aspectRatio: 2 / 3, borderRadius: 3, backgroundColor: COLORS.imagePlaceholder, alignItems: 'center', justifyContent: 'center' },
