...
import { ScreenShell, ScreenHeader, SectionHeader, SegmentedFilter, PrismeCard } from '@/components/prisme';
...
export default function Settings() {
  ...
  return (
    <ScreenShell scroll contentContainerStyle={styles.content}>
      <ScreenHeader eyebrow="Réglages" title="Paramètres" subtitle="Compte, affichage et données personnelles." />
